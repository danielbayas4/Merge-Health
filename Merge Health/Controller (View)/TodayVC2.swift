...
class TodayVC4: UIViewController {
    ...
    var quantityMetrics: [QuantityMetric] = [RestingHeartRateM.shared, Steps.shared]
...
extension TodayVC4: UITableViewDelegate {
...
extension TodayVC4: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if currentMetric == todayTVC_Names.restingHeartRate {
